function [Tsyn,Tsyn_days,Tsyn_years] = computeTsynLeg2(a1, a2, mu)
%
% DESCRIPTION:
%   Calculates the synodic period of bodies in the second interplanetary
%   leg
% INPUT:
...
% -------------------------------------------------------------------------
    ...
    fprintf('\n--- Synodic Period ---\n');
    fprintf('Mars-Asteroid Synodic Period: %.2f days (%.2f years)\n', ...
