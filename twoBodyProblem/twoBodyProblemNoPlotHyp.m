function [t,s,values] = twoBodyProblemNoPlotHyp(mu,s0,nPeriods,time)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   REDUNDANCY IN SOME ANALYSIS EXTENDED TO ADMIT ALSO HYPERBOLIC ORBITS
%
% INPUTS
...
elseif strcmp(type, 'parabolic');
    ...
    if isempty(time)
        error('error: for open orbits need to specify "time".');
    else
        tspan = time;
    end

else strcmp(type, 'hyperbolic');
